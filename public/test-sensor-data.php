...
// File ini untuk testing preview sensor monitoring dengan data dummy
// Men-disable platform check sementara untuk testing

if (file_exists(__DIR__.'/../vendor/autoload.php')) {
    // Override platform check
    $autoload = __DIR__.'/../vendor/autoload.php';
    
    // Include autoload tanpa platform check
    require_once $autoload;
    
    // Create simple data untuk testing
