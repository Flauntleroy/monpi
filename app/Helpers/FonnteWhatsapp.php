...
class FonnteWhatsapp
{
    public static function send($message, $phone = null, $cooldownMinutes = 15)
    {
        try {
            ...
            // Cek apakah pesan yang sama sudah dikirim dalam periode cooldown
            ...
            // Jika berhasil dikirim, set cooldown
    ...
    {
        // Key berdasarkan endpoint dan jenis error (tanpa timestamp)
    ...
    {
        // Key berdasarkan endpoint (tanpa response time yang selalu berubah)
